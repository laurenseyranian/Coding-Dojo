...
#2a Store your name in a variable, and then use it to print the string “Hello {{your name}}!” using a comma in the print function (#2a)
name= "Lauren"
print( "Hello", name, "!")
...
name = 24
print( "Hello", name, "!")
#3bStore your favorite number in a variable, and then use it to print the string “Hello {{num}}!” using a + in the print function (#3b)
name = 24
...
fave_one = "burritos"
fave_two = "tacos"
print( "I love to eat {} and {}.".format(fave_one, fave_two)) # with .format()
...
fave_one = "burritos"
fave_two = "tacos"
print( f"I love to eat {fave_one} and {fave_two}." ) # with an f string
